...
export default function ProfileForm({ user, onSaved }) {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="bg-white border border-ink/10 rounded-3xl p-6 md:p-8 space-y-5">
      ...
      <FormField id="account-email" label="ایمیل" type="email" dir="ltr" value={form.email} onChange={handleChange("email")} error={errors.email} placeholder="name@email.com" inputClass={inputClass(errors.email)} />
