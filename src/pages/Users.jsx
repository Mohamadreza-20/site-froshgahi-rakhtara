...
export default function Users() {
  ...
  if (state.loading) return <QueryLoadingState message="در حال بارگذاری کاربران..." />;
  if (state.error) return <QueryErrorState message="خطا در دریافت کاربران" onRetry={state.refetch} />;
